...
Check the [releases](https://github.com/droboports/par2cmdline/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/par2cmdline.git
cd par2cmdline
./build.sh
ls -la *.tgz
```
